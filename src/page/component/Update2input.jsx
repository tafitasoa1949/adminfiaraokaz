...
function Update2input({onClose,handlerA,handlerB,modif,nomA,nomB ,titel,nomP,handlerP}) {
                    ...
                    <div className="login-wrap p-4 p-lg-5">
                        ...
                        <form  className="signin-form" onSubmit={onsubRecherche} >
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input type="text" className="form-control"    onChange={(e) => handlerA(e)} />
                            </div>
                            <div className="form-group mb-3">
                                <label className="label" htmlFor="password">Nom value {nomB}  </label>
                                <input type="text" className="form-control"     onChange={(e) => handlerB(e)} />
                            </div>
                            <div className="form-group mb-3">
                                <label className="label" htmlFor="password">Pourcentage {nomP}  </label>
                                <input type="text" className="form-control"    onChange={(e) => handlerP(e)} />
                            </div>
